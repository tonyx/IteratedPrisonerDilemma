...
//        public const int NUM_OF_LOW_RANK_ANIMAL_WHO_WILL_DIE = (int)NUMBER_OF_ANIMALS/10; // deprecated
        ...
        private void Init() {
            payoff_matrix = new Dictionary<Tuple<PlayMoves,PlayMoves>,int[]> {
                {new Tuple<PlayMoves,PlayMoves>(PlayMoves.Defect,PlayMoves.Defect) ,new int[]{4,4}},
                {new Tuple<PlayMoves,PlayMoves>(PlayMoves.Defect,PlayMoves.Cooperate) ,new int[]{10,0}},
                {new Tuple<PlayMoves,PlayMoves>(PlayMoves.Cooperate,PlayMoves.Defect) ,new int[]{0,10}},
